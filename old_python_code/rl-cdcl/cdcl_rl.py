...
class CDCLSolverRL(CDCLCore):
    ...
    def __init__(self, num_vars: int, clauses: List[List[int]]):
        ...
        # Remove slow heuristics: DLIS (O(N)), Random
        self.heuristics: List[HeuristicStrategy] = [VSIDSStrategy(), JWStrategy()]
        ...
        # Increase epoch size to allow heuristics to stabilize
        self.epoch_size = 500
    ...
    def _end_epoch_update(self, final: bool = False):
        ...
        if self.logger is not None:
            ...
            # add context features with names
    ...
    def _start_new_epoch(self):
        ...
        # Warm Start: Force VSIDS (arm 0) for the first epoch
